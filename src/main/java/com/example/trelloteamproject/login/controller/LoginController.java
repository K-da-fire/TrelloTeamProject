...
public class LoginController {
    ...
    public ResponseEntity<MemberResponseDto> signUp(
        ...
        return ResponseEntity.ok().body(loginService.signUp(userRequestDto.getEmail(), userRequestDto.getPassword(), userRequestDto.getName(), userRequestDto.getAuth(), userRequestDto.getRole()));
    }
}
